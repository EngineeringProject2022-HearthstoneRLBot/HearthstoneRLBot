    ...
    def trigger(self, source):
        ...
        for i in range(times):
            ...
            for target in targets:
                ...
                try:
                    if (type(self) is Summon and len(target_args[0]) != 0 and target_args[0][0].type == 4 and target.minion_slots < 1) or (
                        (type(self) is Steal and target.type == 4 and source.controller.minion_slots < 1)
                    ):
                        break
